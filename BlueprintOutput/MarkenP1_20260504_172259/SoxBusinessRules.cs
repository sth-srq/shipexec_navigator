...
using ShipExec.BusinessRules.Helpers;
...
namespace PSI.Sox
{
    ...
    public class SoxBusinessRules : IBusinessObject
    {
        ...
        {
            var mgr = new ReturnsPickupManager(Logger, BusinessObjectApi, Profile, BusinessRuleSettings, ClientContext);
            return (ShipmentResponse)mgr.Ship(shipmentRequest, pickup, shipWithoutTransaction, print, userParams);
        }
