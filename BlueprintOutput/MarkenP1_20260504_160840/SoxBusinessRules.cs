...
namespace PSI.Sox
{
    ...
    public class SoxBusinessRules : IBusinessObject
    {
        ...
        {
            var mgr = new ReturnsShipmentManager(Logger, BusinessObjectApi, BusinessRuleSettings, Profile, ClientContext);
        ...
        {
            var mgr = new PickupAssociationManager(Logger, BusinessObjectApi, BusinessRuleSettings, Profile, ClientContext);
        ...
        /// </summary>
        /// <param name="packingRateRequest">PackingRateRequest object containing the information for the package that was pack rated.</param>        
