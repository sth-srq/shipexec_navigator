...
using ShipExecNavigator.RAGLoader;
using System.Text;
...
Console.WriteLine("ShipExecNavigator RAG Document Loader");
Console.WriteLine("======================================");
...
Console.WriteLine("Done. Start ShipExecNavigator — the AI will now use these documents for context.");
return 0;
